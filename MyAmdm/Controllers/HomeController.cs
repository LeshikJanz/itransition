    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
           ...
           // SaveAuthorModelsToDb();
            ...
            /*ParseSongLinks();  //Вот это раскоммитить и показать
            ParseSongLyrics();
            GenerateSongsListOfModels();
            SaveSongModelsToDb();*/


            //GenerateAccordsListOfModels();
        ...
        {
            Author firstAuthor = context.Authors.FirstOrDefault();
            int firstAuthorId = firstAuthor.AuthorId;
            foreach (var song in songs)
            {
                song.AuthorId = firstAuthorId++;
                song.NumberOfView = 0;
        ...
        public void ParseAndSaveHandler()
        {  // ?????? как назвать такую функцию
            ...
            foreach (var authorLink in authorBiographyLinks)
            {
                ...
                if (NoAltElements != null)
                {
                    ...
                    foreach (HtmlNode HN in NoAltElements)
                    {
                        ...
                        song.LinkOfSong = "http:" + songLinks[j - 1];
                        song.lyric = songLyrics[j - 1];
                        j++;
                        songs.Add(song);
                    }
                }
        ...
        public List<Accord> GenerateAccordsListOfModels()
        {
            string htmlUrl = "";
